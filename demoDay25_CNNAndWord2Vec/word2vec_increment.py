...
class TrainWord2Vec:
    ...
    def clean_text(self):
        ...
        # pattern=re.compile(r'['+common_util.punc+r']')
        corpus_ = self.data.apply(lambda s: re.sub(r"[{}]+".format(common_util.punc2), '', s))
        # 分词
...
if __name__ == '__main__':
    ...
    trainmodel = TrainWord2Vec(data=corpus, stopword=stop_word,old_path='')
    trainmodel.main()